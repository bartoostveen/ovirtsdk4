...
- Bump apache-commons-io to 2.7
- Build on Java 21
- Drop dependency on python-six
- Convert tests from nose to pytest
- Update Java and Weld dependencies
- Bump model to 4.6.1
- Bump metamodel to 1.3.11
...
- Add Hosted Engine disk types to content type
  Bug-Url: [1663626](https://bugzilla.redhat.com/1663626).
- Add Hosted Engine disk types to content type
  Bug-Url: [1600788](https://bugzilla.redhat.com/1600788).
...
- Add `activate` input param to add/install/approve host
  [1561539](http://bugzilla.redhat.com/1561539).
- Added support for incremental backup.
- Added block size Storage domain property
  [1592916](https://bugzilla.redhat.com/1592916).
...
- Add vGPU placement to Host
  [1641125](https://bugzilla.redhat.com/1641125).
- Specify cloud-init protocol in vm intialization
  [1611889](https://bugzilla.redhat.com/1611889).
...
- Change HostNic statistics and labels to Link
  [1661207](https://bugzilla.redhat.com/1661207).
...
- Add support for OpenStack Identity API v3
   [1598391](https://bugzilla.redhat.com/1598391).
- Added linkedGlusterVolume to the StorageServerConnection
   type and services
   [1563257](https://bugzilla.redhat.com/1563257).
...
- Add sync all networks in cluster
  [1558847](https://bugzilla.redhat.com/1558847).
- Add note to upgrade host
  [1603020](https://bugzilla.redhat.com/1603020).
- Indicate network operation in progress
  [1477599](https://bugzilla.redhat.com/1477599).
- Poly dhcpv6 and autoconf iface config
  [1360839](https://bugzilla.redhat.com/1360839).
- Add 'Multi Queues Enabled' to VmBase
  [1574771](https://bugzilla.redhat.com/1574771).
- Added Reduce action to Disk services
  [#1443963](https://bugzilla.redhat.com/1443963).
- Add documentation to DiskService
  [1585572](https://bugzilla.redhat.com/1585572).
...
- Add search parameter to providers
  [#1572071](https://bugzilla.redhat.com/1572071).
...
- ImageTransfer - adding 'clientInactivityTimeout' property
  [#1563278](https://bugzilla.redhat.com/1563278).
- Add architecture to OperatingSystemInfo
  [#1552026](https://bugzilla.redhat.com/1552026).
- Add import template from configuration
  [#1526032](https://bugzilla.redhat.com/1526032).
...
- Add new `content_type` attribute to the `Disk` type
  [#1511420](https://bugzilla.redhat.com/1511420).
- Add support for setting external network providers by name when adding
  or updating a cluster [#1511369](https://bugzilla.redhat.com/1511369).
...
- Move virtual NIC profile mappings insde registration configuration
   [#1522799](https://bugzilla.redhat.com/1522799).

Bug fixes:

- Make CPU type optional when adding a cluster
  [#1525912](https://bugzilla.redhat.com/1525912).
...
- Added new `discovered_targets` output parameter to the operation that
  ...
  [#1510860](https://bugzilla.redhat.com/1510860).
...
- Add `auto_sync` attribute to the _OpenStack_ network provider type
  [#1511823](https://bugzilla.redhat.com/1511823).
...
- Add the `force` parameter to the operation that puts a storage domain
  into maintenance mode [#1321585](https://bugzilla.redhat.com/1321585).
...
- Add `quota` and `diskProfile` parameters to the operations that move
  and copy disks [#1496704](https://bugzilla.redhat.com/1496704).
- Add `authenticatedUser` and `effectiveUser` links to the `Api` type
  [#1472418](https://bugzilla.redhat.com/472418).
...
- Add `storageErrorResumeBehaviour` to virtual machines, templates and
  instance types [#1317450](https://bugzilla.redhat.com/1317450).
...
- Fix the documentation of the method that lists events
  [#1447622](https://bugzilla.redhat.com/1447622).
...
- Add the `index` attribute to the `Event` type
  [#1448511](https://bugzilla.redhat.com/1448511).
...
- Add `RefreshLun` method to the service that manages a disk.
  [#1404389](https://bugzilla.redhat.com/1404389).
...
- Don’t require deprecated affinity group attributes
  [#1488729](https://bugzilla.redhat.com/1488729).
- Fix optional fields in storage domain add and update
  [1488929](https://bugzilla.redhat.com/1488929).
...
- Add debug data prefixes to indicate direction
   [#1451042](https://bugzilla.redhat.com/1451042).
- Automatically replace bad token
   [#1434830](https://bugzilla.redhat.com/1434830).
- Add support for asynchronous requests
   [#1436981](https://bugzilla.redhat.com/1436981).
- Add generic writer
   [#1444114](https://bugzilla.redhat.com/1444114).
- Improve error message for wrong content type
   [#1440292](https://bugzilla.redhat.com/1440292).
...
- Move `vnic_profile_mappings` and `reassign_bad_macs` from
  ...
  [#1425731](https://bugzilla.redhat.com/1425731).
...
- Fix reading of XML attributes of enum types
  [#1408839](https://bugzilla.redhat.com/1408839)
...
- Enable compression by default [#1367826](https://bugzilla.redhat.com/1367826).

## 4.0.4 / Tue 15 2016

Bug fixes:

- Use COPYPOSTFIELDS for HTTP POST data [#1392878](https://bugzilla.redhat.com/1392878).
...
- Fix the type of the `usages` attribute of the `Network` type, it
  ...
  of strings.
- Fix reading of lists of elements [#1373431](https://bugzilla.redhat.com/1373431).
